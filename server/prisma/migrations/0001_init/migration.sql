...
CREATE TABLE "content_cache" (
    ...
    CONSTRAINT "content_cache_pkey" PRIMARY KEY ("external_id","content_type")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "library_items_user_id_external_id_content_type_key" ON "library_items"("user_id", "external_id", "content_type");

-- CreateIndex
CREATE INDEX "idx_preferences_user" ON "user_preferences"("user_id");

-- AddForeignKey
ALTER TABLE "library_items" ADD CONSTRAINT "library_items_external_id_content_type_fkey" FOREIGN KEY ("external_id", "content_type") REFERENCES "content_cache"("external_id", "content_type") ON DELETE RESTRICT ON UPDATE CASCADE;
